...
log_debug "triggered by: $1, line 39"
...
if [ ! -s "/opt/etc/asus_lighttpd/server.pem" ]; then
sh /opt/etc/asus_script/gencert.sh
fi
fi
if [ "$1" == "start" ] || [ "$1" == "restart" ]; then
log_debug "triggered by: $1, line 52"
...
log_debug "triggered by: $1 line: 59 (sleep 2)"
sleep 2
...
case "$1" in
  ...
  log_debug "triggered by: $1, line 91-92"
...
log_debug "triggered by: $1 line: 118 (sleep 3)"
sleep 3
cd  /opt/bin
...
killall -SIGTERM asus_lighttpd&
log_debug "triggered by: $1 line: 169 (sleep 3)"
sleep 3
cd  /opt/bin
./asus_lighttpd -Df /opt/etc/asus_lighttpd.conf&
    ;;
...
rm -rf /tmp/APPS/Lighttpd/compress/downloadmaster&
log_debug "triggered by: $1 line: 186 (sleep 2)"
sleep 2
...
rm -rf /tmp/APPS/DM2/Config/dm2_detect_protected &
rm -rf /tmp/APPS/Lighttpd/compress/downloadmaster&
log_debug "triggered by: $1 line: 200 (sleep 2)"
sleep 2
