...
- **The Play Store "what's new" is deliberately a one-liner pointing at the hosted changelog**, written by `release.yml` rather than from CHANGELOG.md. That field is small, and the house style - following what Anthropic and others do - is to keep one canonical changelog rather than maintain a second short copy that drifts.
