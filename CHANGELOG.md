...
2026-09-20 v0.8.87 build 457 - fix watchdog deployment
...
2026-09-20 v0.8.86 build 456 - a run sheet that survives its own tests, and the app's house style written down
...
2026-09-20 v0.8.85 build 455 - a watchdog that asks whether names resolve, not just whether packets move
